...
# The file currently has a simple NewsArticle schema. We'll replace it with
# Article + FAQPage JSON-LD and add dateModified.
...
# ── 3) Insert before Global CTA ─────────────────────────────────
# The file has a specific structure - need to find the right marker
marker = '</main>\n    <!-- ========================================== -->\n    <!-- 以上區塊為每篇文章需要替換的內容 -->\n    <!-- ========================================== -->\n\n    <!-- Global CTA -->'
replacement = '</main>\n    <!-- ========================================== -->\n    <!-- 以上區塊為每篇文章需要替換的內容 -->\n    <!-- ========================================== -->\n' + new_sections + '\n    <!-- Global CTA -->'
...
print("✅ special_industries.html updated")
...
date_modified_ok = '"dateModified": "2026-07-15"' in content
faq_ld_ok = '"Question"' in content and content.count('"@type": "Question"') >= 6
...
print(f"  dateModified  : {date_modified_ok}")
print(f"  FAQ JSON-LD   : {faq_ld_ok}")
